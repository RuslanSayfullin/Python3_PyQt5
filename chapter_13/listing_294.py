# Использование классов QPrintDialog и QPageSetupDialog
...
class MyWindow(QtWidgets.QWidget):
    ...
    def print(self):
        ...
        if pd.exec() == QtWidgets.QDialog.Accepted:
            ...
            pixmap = pixmap.scaled(self.printer.width(), self.printer.height(), aspectRatioMode=QtCore.Qt.KeepAspectRatio)
